...
columns =[
	...
	{'name': 'board_mac', 'label': 'Base MAC', 'field': 'board_mac', 'align': 'left', 'sortable': True},
	{'name': 'name', 'label': 'Name', 'field': 'name', 'align': 'left', 'sortable': True}
]
result_data = [{'serial':'FP231GTF00000001','board_mac':'01:23:45:67:89:10','name':'Example AP Name'}] 
...
with ui.row():
	ui.button("Go", on_click=lambda:getResults(result_data))
